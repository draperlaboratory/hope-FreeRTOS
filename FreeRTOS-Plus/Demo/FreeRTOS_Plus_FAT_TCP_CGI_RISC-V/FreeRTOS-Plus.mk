...
FREERTOS_FAT_DEMO_DIR := \
	$(FREERTOS_PLUS_CMN_DIR)/FreeRTOS_Plus_FAT_SL_Demos

FREERTOS_FAT_GENERATED_DIR := \
	$(FREERTOS_FAT_DEMO_DIR)/CreateExampleFiles/generated

FREERTOS_FAT_GENERATED_HEADERS := $(FREERTOS_FAT_GENERATED_DIR)/*.h

FREERTOS_FAT_WEB_DIR := \
	$(FREERTOS_FAT_DEMO_DIR)/www

FREERTOS_FAT_WEB_PAGES := $(FREERTOS_FAT_WEB_DIR)/*.html
