#!/bin/bash
# This script runs the webserver for collecting *privilege* files: .cmap and .cmap_weighted
...
cp result.cmap FreeRTOS-web-server.elf.cmap
cp result_weighted.cmap FreeRTOS-web-server.elf.weighted.cmap
